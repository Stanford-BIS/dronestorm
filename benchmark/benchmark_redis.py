...
rdb.reset_db()
reset_dt = timeit.default_timer() - start
...
for i in range(N):
    ...
    set_dt[i] = timeit.default_timer() - start
set_dt *= 1000 # to ms
...
for i in range(N):
    ...
    get_dt[i] = timeit.default_timer() - start
get_dt *= 1000 # to ms
...
for i in range(N):
    ...
    pipelined_set_dt[i] = timeit.default_timer() - start
...
for i in range(N):
    ...
    pipelined_get_dt[i] = timeit.default_timer() - start
