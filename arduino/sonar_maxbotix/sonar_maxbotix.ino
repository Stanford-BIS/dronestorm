...
// These are the two commands that need to be sent in sequence
// to change the sensor address
...
// Returns the last range that the sensor determined in its last ranging cycle
// in centimeters. Returns 0 if there is no communication.
word requestRange() {
